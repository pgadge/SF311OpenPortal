...
public class MyServiceRequestsPortlet extends GenericPortlet 
{
	...
	{ 
		String wsUrl = getPrefAttribute(renderRequest,SF311Constants.MY_SRV_REQ_WS_URL);
		String caseUrl = getPrefAttribute(renderRequest,SF311Constants.MY_CASE_WS_URL); 
		...
		else
		{
			...
			wsUrl = getPrefAttribute(renderRequest,SF311Constants.MY_SRV_REQ_WS_URL);
			caseUrl = getPrefAttribute(renderRequest,SF311Constants.MY_CASE_WS_URL); 
	...
	public void processAction(ActionRequest actionRequest,	ActionResponse actionResponse) throws IOException, PortletException 
	{
		...
		if("configureWebService".equalsIgnoreCase(action))
		{
			...
			preferences.setValue(SF311Constants.MY_SRV_REQ_WS_URL,wsUrl);
			preferences.setValue(SF311Constants.MY_CASE_WS_URL,caseUrl);
			preferences.store();
